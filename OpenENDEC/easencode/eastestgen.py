...
def generateEASpcmData(
    ...
    header = generateAFSKpcmData(
        ...
        peakLevel,
        numCh,
        preamble + message.upper(),
    )
    eom = generateAFSKpcmData(
        markF,
        spaceF,
        bitrate,
        sampRate,
        ...
        peakLevel,
        numCh,
        preamble + endOfMessage,
    )
    silence = generateSimplePCMToneData(
        10000, 10000, sampRate, 1, sampWidth, -94, numCh
    )
