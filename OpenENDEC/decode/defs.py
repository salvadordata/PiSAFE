...
def validate_county_code(code):
    return code in US_SAME_CODE

def get_county_name(code):
    return US_SAME_CODE.get(code, "County not found")
...
SAME__ORG = {
    ...
    "CIV": {
        "NAME": {"US": "Civil authorities", "CA": "Civil authorities"},
        "PLURAL": True,
        "ARTICLE": {"US": "THE", "CA": "THE"},
    },
    "WXR": {
        "NAME": {"US": "National Weather Service", "CA": "Environment Canada"},
        "PLURAL": False,
        "ARTICLE": {"US": "THE", "CA": ""},
    },
    "PEP": {
